...
;!function(win){
  ...
  ,modules = {
    ...
    ,form: 'layform' //表单集
    ,upload: 'layupload' //上传
    ,transfer: 'laytransfer' //上传
    ,tree: 'laytree' //树结构
    ,table: 'laytable' //表格
    ,element: 'layelement' //常用元素操作
    ,rate: 'layrate'  //评分组件
    ,colorpicker: 'laycolorpicker' //颜色选择器
    ,slider: 'layslider' //滑块
    ,carousel: 'laycarousel' //轮播
    ,flow: 'layflow' //流加载
    ,util: 'layutil' //工具块
    ,code: 'laycode' //代码修饰器
    ,jquery: 'layjquery' //DOM库（第三方）
    ,mobile: 'laymobile' //移动大模块 | 若当前为开发目录，则为移动模块入口，否则为移动模块集合
